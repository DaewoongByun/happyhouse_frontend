<template>
  <div id="Board_Article" class="container">
    ...
    <div  class="footer flex-box">
        <b-button variant="outline-primary" v-if="checkMyArticle" @click="modifyArticle">수정</b-button>
        <b-button variant="outline-danger" v-if="checkMyArticle" @click="deleteArticle">삭제</b-button>

  ...
  methods: {
    ...
    initMap() {
      if (this.houseinfos.length === 0) {
        ...
        const options = {
          center: new kakao.maps.LatLng(36.35513321021629, 127.29836175576918),
          level: 3,
        };
        ...
        const container = document.querySelector('#map');
        const options = {
          center: new kakao.maps.LatLng(this.houseinfos[0].lat, this.houseinfos[0].lng),
          level: 5,
        };
        const map = new kakao.maps.Map(container, options);

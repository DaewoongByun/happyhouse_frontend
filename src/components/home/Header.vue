<template>
  <div id="header" class="container-fluid">
    <div class="header__title">
      <div @click="goHome" class="header__title__text">
        <img
          src="https://see.fontimg.com/api/renderfont4/eZVa6/eyJyIjoiZnMiLCJoIjozNiwidyI6MTAwMCwiZnMiOjM2LCJmZ2MiOiIjQzc2MjM1IiwiYmdjIjoiI0ZGRkZGRiIsInQiOjF9/SEFQUFkgSE9VU0U/esporte-personal-use.png"
          alt="Sports fonts"
        />
      </div>
    </div>
